...
</span><span class="stkSel_yes"><span>Interface
...
précédente</span>](Store.md "page précédente(The Store Object)")<span class="hidden">
| </span>[<span>page
suivante</span>](GeneralFeatures.md "page suivante(General Features)")
...
operations, choosing options or items, displaying results etc., by
mirroring "standard" user interfaces or **dialog items** – buttons, pop
up menus or sliders.
  ...
  - [<span>OM 6.6 User Manual</span>](OM-User-Manual.md)
      ...
      - [<span>Visual Programming
        II</span>](AdvancedVisualProgramming.md)
          ...
          - <span id="i0" class="outLeftSel_yes"><span>Interface
            Boxes</span></span>
