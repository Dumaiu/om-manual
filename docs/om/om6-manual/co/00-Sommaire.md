...
précédente</span>](OM-User-Manual.md "page précédente(OM 6.6 User Manual)")<span class="hidden">
| </span>[<span>page
suivante</span>](01-Presentation.md "page suivante(OpenMusic Presentation)")
...
<div id="mnuScroll">
  ...
  - [<span>OM 6.6 User Manual</span>](OM-User-Manual.md)
      - <span id="i0" class="outLeftSel_yes"><span>Introduction</span></span>
          - [<span>OpenMusic Presentation</span>](01-Presentation.md)
          - [<span>Additional Information</span>](02-SupportAndPubs.md)
          - [<span>Elementary F.A.Q.</span>](03-FAQ.md)
