...
</span><span class="stkSel_yes"><span>File-Box</span></span></span>
...
précédente</span>](DefDirectories.md "page précédente(Default Directories)")<span class="hidden">
| </span>[<span>page
suivante</span>](FileBoxIntro.md "page suivante(Introduction)")
...
# <span>File-Box : Iterative File Input/Output Processes</span>
...
The **File-Box** is an extension of **** [<span> ****OMLoop****
</span>](OMLoop.md) **** used for programming iterative processes while
...
![fileboxmenu.png](../res/fileboxmenu.png)
      ...
      - [<span>Visual Programming
        II</span>](AdvancedVisualProgramming.md)
          ...
          - [<span>Files</span>](Files.md)
              ...
              - <span id="i0" class="outLeftSel_yes"><span>File-Box</span></span>
