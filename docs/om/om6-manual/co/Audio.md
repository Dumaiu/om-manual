...
</span><span class="stkSel_yes"><span>Audio</span></span></span>
...
précédente</span>](MIDIContainer.md "page précédente(MIDI Containers)")<span class="hidden">
| </span>[<span>page
suivante</span>](Sound.md "page suivante(Sound Object)")
...
<div id="mnuScroll">
  ...
  - [<span>OM 6.6 User Manual</span>](OM-User-Manual.md)
      ...
      - <span id="i0" class="outLeftSel_yes"><span>Audio</span></span>
