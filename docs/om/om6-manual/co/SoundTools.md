...
</span><span class="stkSel_yes"><span>Sound Tools</span></span></span>
...
précédente</span>](AudioPlayer.md "page précédente(Audio Player)")<span class="hidden">
| </span>[<span>page
suivante</span>](SoundProcessing.md "page suivante(Sound Processing)")
...
<p>The SOUND-POINTS function allows to downsample the sound waveofrm and extract a number of points out of it.</p>
</div></td>
<td><div class="caption">
<div class="caption_co">
<img src="../res/sound-points.png" width="268" height="279" alt="SOUND-POINTS : downsampling a sound waveform. The sample values are displayed in a BPF (note that the number of decimals in the BPF has to be increased due to the range and precision of the sample values)." />
</div>
...
<div id="mnuScroll">
  ...
  - [<span>OM 6.6 User Manual</span>](OM-User-Manual.md)
      ...
      - [<span>Audio</span>](Audio.md)
          ...
          - <span id="i0" class="outLeftSel_yes"><span>Sound
            Tools</span></span>
