...
</span><span class="stkSel_yes"><span>Manipulating the
...
précédente</span>](2_progpatch.md "page précédente(Programming a Simple Patch)")<span class="hidden">
| </span>[<span>page
suivante</span>](4_MusicalAp.md "page suivante(A Musical Application)")
...
# <span>Manipulating the Patch in the Workspace</span>
