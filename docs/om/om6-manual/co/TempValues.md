...
précédente</span>](Appearance.md "page précédente(Temporalboxes Appearance)")<span class="hidden">
| </span>[<span>page
suivante</span>](PatchValue.md "page suivante(Patches)")
...
Each box in the maquette has a value. This value can be a musical value
and/or a simple computational value.
  ...
  - [<span>OM 6.6 User Manual</span>](OM-User-Manual.md)
      ...
      - [<span>Maquettes</span>](Maquettes.md)
          ...
          - [<span>TemporalBoxes</span>](TemporalBoxes.md)
              ...
              - <span id="i0" class="outLeftSel_yes"><span>TemporalBoxes
                Value</span></span>
