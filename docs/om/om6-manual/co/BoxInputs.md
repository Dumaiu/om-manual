...
</span><span class="stkSel_yes"><span>Box Inputs</span></span></span>
...
précédente</span>](OtherBoxes.md "page précédente(Other Boxes)")<span class="hidden">
| </span>[<span>page
suivante</span>](StandardInputs.md "page suivante(Standard Inputs)")
...
correspond to the arguments of a function, or to the attributes of an
object, depending on the type of the box.
...
<div id="mnuScroll">
  ...
  - [<span>OM 6.6 User Manual</span>](OM-User-Manual.md)
      ...
      - [<span>Visual Programming I</span>](BasicVisualProgramming.md)
          ...
          - <span id="i0" class="outLeftSel_yes"><span>Box
            Inputs</span></span>
