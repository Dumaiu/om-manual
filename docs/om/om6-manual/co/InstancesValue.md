...
précédente</span>](MaquetteValue.md "page précédente(Sub Maquettes)")<span class="hidden">
| </span>[<span>page
suivante</span>](Editor.md "page suivante(The Maquette Editor)")
...
## <span>Instance Boxes and Factory Boxes</span>
...
Copies of factory boxes and instances can be modified via this editor,
without affecting the master item.
...
Conversely, modifications of global variables have an effect on all
their representations, like in patches.
...
![modifglob1.png](../res/modifglob1.png)
      ...
      - [<span>Maquettes</span>](Maquettes.md)
          ...
          - [<span>TemporalBoxes</span>](TemporalBoxes.md)
              ...
              - [<span>TemporalBoxes Value</span>](TempValues.md)
                  ...
                  - <span id="i2" class="outLeftSel_yes"><span>Instances</span></span>
