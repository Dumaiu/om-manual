...
</span><span class="stkSel_yes"><span>Manipulating the Chord
Box</span></span></span>
...
précédente</span>](5_CompletEdition.md "page précédente(Manipulating and Visualizing Objects)")<span class="hidden">
| </span>[<span>page
suivante</span>](5bComplete.md "page suivante(Completing the Edition)")
...
# <span>Manipulating the Chord Box</span>
  ...
  - [<span>OpenMusic QuickStart</span>](QuickStart-Chapters.md)
      ...
      - [<span>Manipulating and Visualizing
        Objects</span>](5_CompletEdition.md)
          - <span id="i1" class="outLeftSel_yes"><span>Manipulating the
            Chord Box</span></span>
