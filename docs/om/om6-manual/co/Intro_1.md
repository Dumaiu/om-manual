...
</span><span class="stkSel_yes"><span>Summary</span></span></span>
...
précédente</span>](QuickStart-Chapters.md "page précédente(OpenMusic QuickStart)")<span class="hidden">
| </span>[<span>page
suivante</span>](1_StartSession.md "page suivante(Starting a Session)")
...
<div id="mnuScroll">
  ...
  - [<span>OpenMusic QuickStart</span>](QuickStart-Chapters.md)
      - <span id="i0" class="outLeftSel_yes"><span>Summary</span></span>
