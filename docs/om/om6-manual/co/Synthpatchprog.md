...
</span><span class="stkSel_yes"><span>The Synthesis
...
précédente</span>](MaquetteEvaluation.md "page précédente(Evaluation)")<span class="hidden">
| </span>[<span>page
suivante</span>](Synthesispatch.md "page suivante(Maquette Value)")
...
# <span>An Alternate Evaluation Tool : the Synthesis Patch</span>
...
A maquette contains all types of objects : numeric values, chords,
patches... The values of TemporalBoxes within a maquette can be used as
**functional parameters** in a program that will be interpreted
musically. To do so, we need a special type of patch : a synthesis
patch.
      ...
      - [<span>Maquettes</span>](Maquettes.md)
          ...
          - [<span>Maquette
            Programming</span>](Programming%20Maquette.md)
              ...
              - <span id="i0" class="outLeftSel_yes"><span>The Synthesis
                Patch</span></span>
