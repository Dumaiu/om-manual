...
précédente</span>](Editor-Basics.md "page précédente(Basic Editing)")<span class="hidden">
| </span>[<span>page
suivante</span>](Editor-Pitch.md "page suivante(Pitches)")
...
# <span>Harmonic Objects : Note, Chord and Chord-Seq Editors</span>
...
chord and chord-seq editors, and those regarding chords are of course
valid for chord-seq editors.
  ...
  - [<span>OM 6.6 User Manual</span>](OM-User-Manual.md)
      ...
      - [<span>Score Objects</span>](ScoreObjects.md)
          ...
          - [<span>Score Editors</span>](ScoreEditors.md)
              ...
              - <span id="i0" class="outLeftSel_yes"><span>Harmonic
                Objects</span></span>
