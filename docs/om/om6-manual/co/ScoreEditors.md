...
</span><span class="stkSel_yes"><span>Score Editors</span></span></span>
...
précédente</span>](ScorePlayer.md "page précédente(Score Players)")<span class="hidden">
| </span>[<span>page
suivante</span>](Editor-Overview.md "page suivante(Overview)")
