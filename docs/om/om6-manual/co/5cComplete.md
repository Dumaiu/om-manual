...
</span><span class="stkSel_yes"><span>Listening to
Microintervals</span></span></span>
...
précédente</span>](5bComplete.md "page précédente(Completing the Edition)")<span class="hidden">
| </span>[<span>page
suivante</span>](5dComplete.md "page suivante(Comments)")
...
# <span>Listening to Microintervals</span>
  ...
  - [<span>OpenMusic QuickStart</span>](QuickStart-Chapters.md)
      ...
      - [<span>Manipulating and Visualizing
        Objects</span>](5_CompletEdition.md)
          ...
          - <span id="i1" class="outLeftSel_yes"><span>Listening to
            Microintervals</span></span>
