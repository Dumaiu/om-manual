...
<span>How to Add a Function Into a Patch Editor</span>
...
Most of the time, it is necessary to type the name of such a function to
...
For instance, a generic function "OM+" has set 4 different methods, and
