...
\> </span><span class="stkSel_yes"><span>Evaluators</span></span></span>
...
précédente</span>](LoopGeneral.md "page précédente(General Features)")<span class="hidden">
| </span>[<span>page
suivante</span>](Finally.md "page suivante(Finally)")
...
# <span>Evaluators : Eachtime, Finally, Initdo</span>
...
EachTim**e** : produces the result at each step of the iteration.
      ...
      - [<span>Visual Programming
        II</span>](AdvancedVisualProgramming.md)
          ...
          - [<span>Iterations: OMLoop</span>](OMLoop.md)
              ...
              - <span id="i0" class="outLeftSel_yes"><span>Evaluators</span></span>
