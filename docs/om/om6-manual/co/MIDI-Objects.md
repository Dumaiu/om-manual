...
</span><span class="stkSel_yes"><span>MIDI Objects</span></span></span>
...
précédente</span>](Record%20MIDI.md "page précédente(Recording / MIDI In)")<span class="hidden">
| </span>[<span>page
suivante</span>](MIDIFile.md "page suivante(MIDI File)")
...
MIDI events and data can be materialized and manipulated in OM patches
using the library of MIDI objects.
